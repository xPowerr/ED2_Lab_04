...
SOURCEFILES_QUOTED_IF_SPACED=main.c I2C.c LCD.c IOCB.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/IOCB.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/I2C.p1.d ${OBJECTDIR}/LCD.p1.d ${OBJECTDIR}/IOCB.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/IOCB.p1

# Source Files
SOURCEFILES=main.c I2C.c LCD.c IOCB.c
...
${OBJECTDIR}/IOCB.p1: IOCB.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/IOCB.p1.d 
	@${RM} ${OBJECTDIR}/IOCB.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none    -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/IOCB.p1 IOCB.c 
	@-${MV} ${OBJECTDIR}/IOCB.d ${OBJECTDIR}/IOCB.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/IOCB.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
